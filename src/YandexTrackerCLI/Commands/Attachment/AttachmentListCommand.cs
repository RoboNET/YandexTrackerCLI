...
/// <summary>
/// Команда <c>yt attachment list &lt;issue-key&gt;</c>: выполняет
/// <c>GET /v3/issues/{key}/attachments</c> с пагинацией через
/// <see cref="YandexTrackerCLI.Core.Api.TrackerClient.GetPagedAsync"/> и печатает все
/// элементы как единый JSON-массив на stdout. Лимит записей задаётся через <c>--max</c>.
/// </summary>
public static class AttachmentListCommand
{
    /// <summary>
    /// Строит subcommand <c>list</c> для <c>yt attachment</c>.
    /// </summary>
    ...
    public static Command Build()
    {
        ...
        var cmd = new Command("list", "Список вложений задачи (GET /v3/issues/{key}/attachments).");
