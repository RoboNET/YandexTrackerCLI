...
/// <summary>
/// Команда <c>yt comment delete &lt;issue-key&gt; &lt;comment-id&gt;</c>:
/// выполняет <c>DELETE /v3/issues/{key}/comments/{id}</c>.
/// </summary>
/// <remarks>
/// Поведение вывода:
/// <list type="bullet">
...
/// </list>
/// </remarks>
public static class CommentDeleteCommand
{
    /// <summary>
    /// Строит subcommand <c>delete</c> для <c>yt comment</c>.
    /// </summary>
    ...
    public static Command Build()
    {
        ...
        var cmd = new Command("delete", "Удалить комментарий (DELETE /v3/issues/{key}/comments/{id}).");
