...
/// <summary>
/// Команда <c>yt automation trigger delete &lt;id&gt; --queue &lt;key&gt;</c>:
/// выполняет <c>DELETE /v3/queues/{queue}/triggers/{id}</c>.
/// </summary>
/// <remarks>
/// Поведение вывода:
/// <list type="bullet">
...
/// </list>
/// </remarks>
public static class TriggerDeleteCommand
{
    /// <summary>
    /// Строит subcommand <c>delete</c> для группы <c>yt automation trigger</c>.
    /// </summary>
    ...
    public static Command Build()
    {
        ...
        var cmd = new Command("delete", "Удалить триггер (DELETE /v3/queues/{q}/triggers/{id}).");
