...
/// <summary>
/// Команда <c>yt automation autoaction delete &lt;id&gt; --queue &lt;key&gt;</c>:
/// выполняет <c>DELETE /v3/queues/{queue}/autoactions/{id}</c>.
/// </summary>
/// <remarks>
/// Поведение вывода:
/// <list type="bullet">
...
/// </list>
/// </remarks>
public static class AutoactionDeleteCommand
{
    /// <summary>
    /// Строит subcommand <c>delete</c> для группы <c>yt automation autoaction</c>.
    /// </summary>
    ...
    public static Command Build()
    {
        ...
        var cmd = new Command("delete", "Удалить автодействие (DELETE /v3/queues/{q}/autoactions/{id}).");
