...
/// <summary>
/// Команда <c>yt project delete &lt;id&gt;</c>: выполняет
/// <c>DELETE /v3/entities/project/{id}</c>.
/// </summary>
/// <remarks>
/// Поведение вывода:
/// <list type="bullet">
...
/// </list>
/// </remarks>
public static class ProjectDeleteCommand
{
    /// <summary>
    /// Строит subcommand <c>delete</c> для <c>yt project</c>.
    /// </summary>
    /// <returns>Сконфигурированная <see cref="Command"/>.</returns>
    public static Command Build()
    {
        var idArg = new Argument<string>("id") { Description = "Идентификатор проекта." };
        var cmd = new Command("delete", "Удалить проект (DELETE /v3/entities/project/{id}).");
