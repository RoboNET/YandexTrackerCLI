...
/// <summary>
/// Команда <c>yt worklog delete &lt;issue-key&gt; &lt;worklog-id&gt;</c>: выполняет
/// <c>DELETE /v3/issues/{key}/worklog/{id}</c>.
/// </summary>
/// <remarks>
/// Поведение вывода:
/// <list type="bullet">
...
/// </list>
/// </remarks>
public static class WorklogDeleteCommand
{
    /// <summary>
    /// Строит subcommand <c>delete</c> для <c>yt worklog</c>.
    /// </summary>
    ...
    public static Command Build()
    {
        ...
        var cmd = new Command("delete", "Удалить запись учёта времени (DELETE /v3/issues/{key}/worklog/{id}).");
