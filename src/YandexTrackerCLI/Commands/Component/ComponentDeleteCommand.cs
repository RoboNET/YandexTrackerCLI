...
/// <summary>
/// Команда <c>yt component delete &lt;id&gt;</c>: выполняет
/// <c>DELETE /v3/components/{id}</c>.
/// </summary>
/// <remarks>
/// Поведение вывода:
/// <list type="bullet">
...
/// </list>
/// </remarks>
public static class ComponentDeleteCommand
{
    /// <summary>
    /// Строит subcommand <c>delete</c> для <c>yt component</c>.
    /// </summary>
    /// <returns>Сконфигурированная <see cref="Command"/>.</returns>
    public static Command Build()
    {
        var idArg = new Argument<string>("id") { Description = "Идентификатор компонента." };
        var cmd = new Command("delete", "Удалить компонент (DELETE /v3/components/{id}).");
