...
public sealed class TrackerClientTests
{
    ...
    [Arguments(HttpStatusCode.Conflict, ErrorCode.VersionConflict)]
    [Arguments(HttpStatusCode.PreconditionFailed, ErrorCode.VersionConflict)]
    [Arguments(HttpStatusCode.PreconditionRequired, ErrorCode.Unexpected)]
